...
import { USER_PROGRAMS } from "@/dummyData";
      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="bg-card/90 backdrop-blur-sm border border-border rounded-lg overflow-hidden mb-16">
          ...
          <div className="p-8 text-center">
            ...
            {/* STATS */}
            <div className="flex flex-wrap items-center justify-center gap-10 md:gap-16 mt-10 font-mono text-center">
              <div className="flex flex-col items-center">
                <p className="text-3xl text-primary font-semibold">500+</p>
              ...
              <div className="flex flex-col items-center">
                <p className="text-3xl text-primary font-semibold">3.5 min</p>
                <p className="text-sm text-muted-foreground uppercase tracking-wide mt-1">
                  AI PLAN GENERATION
                </p>
              </div>
              <div className="hidden md:block w-px h-12 bg-border"></div>
              <div className="flex flex-col items-center">
                <p className="text-3xl text-primary font-semibold">100%</p>
                <p className="text-sm text-muted-foreground uppercase tracking-wide mt-1">
                  FULLY PERSONALIZED
                </p>
              </div>
